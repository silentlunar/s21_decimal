...
START_TEST(test_sub_1) {
  ...
  s21_out = s21_sub(src1, src2, &result);
  expected = 0;
  // origin = 3;
...
START_TEST(test_sub_8) {
  ...
  src1.bits[3] = 0b00000000000000000000000000000000;
  // src2 = -15657684;
  src2.bits[0] = 0b00000000111011101110101011010100;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  ...
  expected = 0;
  // origin = 15657704;
  origin.bits[0] = 0b00000000111011101110101011101000;
  origin.bits[1] = 0b00000000000000000000000000000000;
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b00000000000000000000000000000000;
  ck_assert_int_eq(origin.bits[3], result.bits[3]);
...
START_TEST(test_sub_9) {
  ...
  int s21_out, expected;
  // src1 = 1568765;
  src1.bits[0] = 0b00000000000101111110111111111101;
  src1.bits[1] = 0b00000000000000000000000000000000;
  src1.bits[2] = 0b00000000000000000000000000000000;
  src1.bits[3] = 0b00000000000000000000000000000000;
  // src2 = 185;
  src2.bits[0] = 0b00000000000000000000000010111001;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000000000000000000000;
  s21_out = s21_sub(src1, src2, &result);
  expected = 0;
  // origin = 1568580;
  origin.bits[0] = 0b00000000000101111110111101000100;
  origin.bits[1] = 0b00000000000000000000000000000000;
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b00000000000000000000000000000000;
  ck_assert_int_eq(origin.bits[3], result.bits[3]);
...
START_TEST(test_sub_10) {
  ...
  int s21_out, expected;
  // src1 = -5421687;
  src1.bits[0] = 0b00000000010100101011101001110111;
  src1.bits[1] = 0b00000000000000000000000000000000;
  src1.bits[2] = 0b00000000000000000000000000000000;
  ...
  expected = 0;
  // origin = -5421688;
  origin.bits[0] = 0b00000000010100101011101001111000;
  origin.bits[1] = 0b00000000000000000000000000000000;
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b10000000000000000000000000000000;
  ck_assert_int_eq(origin.bits[3], result.bits[3]);
...
START_TEST(test_sub_11) {
  ...
  src1.bits[3] = 0b00000000000000000000000000000000;
  // src2 = 18654168;
  src2.bits[0] = 0b00000001000111001010001111011000;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000000000000000000000;
  s21_out = s21_sub(src1, src2, &result);
  expected = 0;
  // origin = -18654167;
  origin.bits[0] = 0b00000001000111001010001111010111;
  origin.bits[1] = 0b00000000000000000000000000000000;
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b10000000000000000000000000000000;
  ck_assert_int_eq(origin.bits[3], result.bits[3]);
